    ...
    <section class="container-fluid text-center">
        <div class="row min-vh-100">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center text-center p-4">
                ...
                <!-- Form Login -->
                <div class="w-75 mt-4">
                    <input type="email" id="email" class="form-control mb-3" placeholder="Email" oninput="checkInputs()">
                    <input type="password" id="password" class="form-control mb-3" placeholder="Password" oninput="checkInputs()">
                    <a class="btn btn-outline-primary w-100" href="#" role="button">Login</a>
                </div>
            </div>
        </div>
    </section>    
